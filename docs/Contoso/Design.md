...
Contoso wants to leverage all Azure regions and deploy the workload closer to the user; and, they will be adding new Azure regions as business demand arises. As a part of North Star design principle of policy-driven governance, Contoso will be assigning policies in their environment with a number of regions they would like to use and Policies will ensure their Azure Environment is setup correctly:
