...
function Get-AzOpsResourceDefinitionAtScope {
    ...
    process {
            ...
            'subscriptions' {
                ...
                if ($true -eq $SkipResourceGroup) {
                    ...
                    $resourcegroup | Foreach-Object -ThrottleLimit $env:AzOpsThrottleLimit -Parallel {
                        ...
                        $rg = $_
                        ConvertTo-AzOpsState -resourceGroup $rg
                        Write-Host "Enumerating Resource Group at $(get-date): $($rg.ResourceId)"
            ...
            'managementGroups' {
                ...
                if ($ChildOfManagementGroups) {
                    ...
                    $ChildOfManagementGroups | Foreach-Object -ThrottleLimit 1 -Parallel {
                        ...
                        Write-Host "Enumerating Child Of Management Group ID: $($child.id) and name: $($child.displayName)"
        ...
        if ($scope.Type -in 'resourcegroups', 'subscriptions', 'managementgroups' -and -not($SkipPolicy)) {
            ...
            Write-Host -Message " - Iterating Policy Definition at scope $scope"
            ...
            Write-Host -Message " - Iterating Policy Set Definition at scope $scope"
            ...
            Write-Host -Message " - Iterating Policy Assignment at scope $scope"
